...
This repository tracks notable **SaaS platforms** and **open-source projects** for **Digital Asset Custody**. These tools secure, manage, and transfer cryptocurrencies and digital assets for institutions, funds, exchanges, DAOs, and enterprises using MPC, multi-signature schemes, HSMs, policy engines, cold storage, and governance controls.

**Examples** include Fireblocks, BitGo, Copper, Anchorage Digital, Fordefi, Qredo (Open Custody Protocol), Coinbase Prime, Ceffu, Zodia Custody, Ledger Enterprise (the category leaders).

**Open-source emphasis**: This section is heavily expanded with every major active project for self-hosting, custom key management, MPC/threshold cryptography, multisig coordination, and transparent custody infrastructure — ideal for institutions seeking sovereignty, developers building non-custodial solutions, researchers, and teams prioritizing auditability over vendor lock-in.
...
- **[Fireblocks](https://www.fireblocks.com/)**  
  Leading MPC-native institutional platform for custody, secure transfers, policy controls, DeFi, staking, and tokenization. Serves 2,400+ institutions with high-volume settlement networks.

- **[BitGo](https://www.bitgo.com/)**  
  Pioneer institutional custodian offering multi-sig/HSM and MPC wallets, qualified custody (federally chartered trust), insurance, staking, and broad asset support across 60+ chains.

- **[Copper](https://copper.co/)**  
  Institutional custody and ClearLoop off-exchange settlement network focused on trading firms, with MPC technology and strong European/MiCA positioning.

- **[Anchorage Digital](https://www.anchorage.com/)**  
  First federally chartered (OCC) digital asset bank in the US providing qualified custody, banking services, staking, and governance for regulated institutions.

- **[Fordefi](https://www.fordefi.com/)**  
  Institutional-grade self-custody MPC wallet platform optimized for DeFi and Web3 treasury management with policy engines, transaction simulation, and browser-native workflows.

- **[Qredo / Open Custody Protocol](https://www.qredo.com/)**  
  Decentralized MPC (dMPC) network for self-custodial institutional vaults, governance controls, and on-chain settlement without traditional private-key storage.

- **[Coinbase Prime / Coinbase Custody](https://www.coinbase.com/prime)**  
  Institutional brokerage and qualified custody platform; primary custodian for the majority of US spot Bitcoin ETF assets with deep liquidity access.

- **[Ceffu](https://www.ceffu.com/)**  
  Institutional MPC custody platform (formerly Binance Custody) offering cold storage, MirrorRSV off-exchange settlement, and liquidity gateways with ISO/SOC certifications.

- **[Zodia Custody](https://www.zodia-custody.com/)**  
  Bank-backed (Standard Chartered) institutional custodian focused on compliance, governance, and regulated markets in Europe and Asia.

- **[Ledger Enterprise](https://www.ledger.com/enterprise)**  
  Hardware-backed enterprise self-custody infrastructure combining Ledger HSMs with governance, multi-approval workflows, and policy controls for corporate treasuries.

### Additional Notable Hosted Platforms
- **[Komainu](https://www.komainu.com/)** — Institutional custody with strong RWA/tokenization focus (e.g., BlackRock BUIDL).
- **[Hex Trust](https://hextrust.com/)** — APAC-licensed institutional custody and digital asset services.
- **[Taurus](https://www.taurushq.com/)** — European banking-integrated custody and tokenization platform.
- **[Dfns](https://www.dfns.co/)** — Wallets-as-a-Service (WaaS) with institutional-grade key management.
- **[Cobo](https://www.cobo.com/)** — Multi-model (MPC, custodial, smart-contract) wallet infrastructure.
...
- Always perform independent due diligence, legal review, and security assessments before deploying any custody solution with real assets.

---
**Made for institutions, treasury teams, DAOs, exchanges, developers, and digital asset technologists.**  
Let's make digital asset custody more open, verifiable, and resilient.
